        ...
        <div>
            ...
            <div className='my-2 container'>
                <div className='row'>
                    ...
                    <Card img='doctor.png' setFilter={props.setFilter} filter="" link="/dsearch" title='Find Doctors Near You' text='Confirmed Appointments' />
                    <Card img='delivery.png' filter="" link="https://www.netmeds.com/" title='Medicines' text='Essentials at your doorstep' />
                    <Card img='labtest.png' filter="" link="/lablist" title='Lab Tests' text='Sample pickup at your home' />
                    <Card img='surgery.png' setFilter={props.setFilter} filter="surgeon" link="/dsearch" title='Surgeries' text='Safe and trusted surgery centers' />
                </div>
